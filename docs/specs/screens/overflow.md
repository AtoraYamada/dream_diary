...
| タグ優先 | 夢を見た日順で最新10回分から2回以上使用されたタグを優先 | ユーザーの関心に沿った内容。毎日書くとは限らないため期間ではなく回数ベース |
...
- 最大10冊の夢日記を抽出
  - 優先順位1: 直近多用タグを含む夢日記を優先
    - 直近: 夢を見た日順で最新10回分（記録日ではなく夢を見た日）
    - 多用タグ: 上記10回分で2回以上使用されたタグ
    - 抽出対象: 多用タグを含む夢を全履歴からランダムに選択
